...
from sklearn.linear_model import Ridge  # Changed to Ridge
...
# Ridge often works well with a wider range, including larger values
param_grid = {
...
print("\n--- Running GridSearchCV for Ridge (v3 data) ---")
...
submission_path = os.path.join(OUTPUT_DIR, 'ridge_tuned_3.csv')
