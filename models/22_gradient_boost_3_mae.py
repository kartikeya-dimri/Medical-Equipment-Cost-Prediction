...
# --- 3. Set up Grid Search with k=3 CV, optimizing for MAE ---
...
print("\n--- Running GridSearchCV for Gradient Boosting (v3 data, optimizing MAE) ---")
...
# --- 4. Show Best Results ---
# Score is negative MAE, so multiply by -1
...
# Update filename
submission_path = os.path.join(OUTPUT_DIR, 'gradient_boosting_grid_3_mae.csv')
