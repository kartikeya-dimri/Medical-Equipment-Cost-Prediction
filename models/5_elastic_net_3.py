...
# Define a grid for both alpha and l1_ratio
param_grid = {
    'alpha': [0.001, 0.01, 0.1, 1.0],
    'l1_ratio': [0.1, 0.5, 0.9] # 0 is Ridge, 1 is Lasso
}
...
print("\n--- Running GridSearchCV for ElasticNet (v3 data) ---")
...
submission_path = os.path.join(OUTPUT_DIR, 'elastic_net_tuned_3.csv')
