...
# This is a small grid; Gradient Boosting can be slow to tune
param_grid = {
...
# Gradient Boosting is slower than Random Forest, so k=3 is a good start
...
print("\n--- Running GridSearchCV for Gradient Boosting (v2 data) ---")
...
submission_path = os.path.join(OUTPUT_DIR, 'gradient_boosting_tuned_2.csv')
