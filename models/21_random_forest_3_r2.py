...
from sklearn.metrics import mean_squared_error, r2_score # Import R2 score
...
# --- 3. Set up Grid Search with k=5 CV, using R-squared ---
...
grid_search = GridSearchCV(
    ...
    cv=kf,
    scoring='r2', # <-- CHANGED SCORING METRIC to R-squared
    n_jobs=-1,
    verbose=2
)

print("\n--- Running GridSearchCV for Random Forest (v3 data, optimizing R-squared) ---")
...
# --- 4. Show Best Results ---
# For R-squared, higher is better, so grid_search.best_score_ is directly the best score
...
# Update filename to reflect R2 optimization
submission_path = os.path.join(OUTPUT_DIR, 'random_forest_grid_3_r2.csv')
