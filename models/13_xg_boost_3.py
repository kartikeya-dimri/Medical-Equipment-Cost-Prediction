...
# Define a grid of parameters to search   'subsample': [0.8, 1.0]
param_grid = {
...
print("\n--- Running GridSearchCV for XGBoost (v3 data) ---")
...
submission_path = os.path.join(OUTPUT_DIR, 'xgboost_grid_3.csv')
